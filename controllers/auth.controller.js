...
const register = async (req, res) => {
	try {
		// Destructure and set default role to 'User'
		const {
			userName,
			email,
			password,
		...
		// Respond with the registered user info, excluding the password
		res.status(201).json({
...
const loginUser = async (req, res) => {
	...
	try {
		...
		// If it's a correct account, skip the password check
...
// Authenticate and register using credential account
const authRegister = async (req, res) => {
	...
	try {
		...
		// Create a new user; age and password are optional
